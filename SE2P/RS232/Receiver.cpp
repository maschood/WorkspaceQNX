	...
	while (!isStopped()) {
		...
		if (readBytes > 0) {
			...
			case RS232_PUCK_ARRIVED_ON_BAND2:
				...
				break;
			case RS232_PUCK_ACC:
				pulseval = RS232_PUCK_ACC;
				coid = dispatcherCoid;
#ifdef DEBUG_Receiver
				printf("DEBUG_Receiver: Received RS232_PUCK_ACC\n");
#endif
				break;
			case RS232_PUCK_METALL_TURNOVER:
				pulseval = RS232_PUCK_METALL_TURNOVER;
				coid = dispatcherCoid;
#ifdef DEBUG_Receiver
				printf("DEBUG_Receiver: Received RS232_PUCK_METALL_TURNOVER\n");
#endif
				break;
			case RS232_PUCK_TURNOVER:
				pulseval = RS232_PUCK_TURNOVER;
				coid = dispatcherCoid;
#ifdef DEBUG_Receiver
				printf("DEBUG_Receiver: Received RS232_PUCK_TURNOVER\n");
#endif
				break;
			default:
#ifdef DEBUG_Receiver
