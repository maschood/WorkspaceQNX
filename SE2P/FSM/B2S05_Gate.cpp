...
//		std::cout<< "Hallo 1" << endl;
	...
	}else if ((controller->getPuckTyp() == RS232_PUCK_ACC || controller->getPuckTyp() == RS232_PUCK_TURNOVER) && (controller->puckType == PUCK_ACCEPTED) && (controller->isInOrder())){
